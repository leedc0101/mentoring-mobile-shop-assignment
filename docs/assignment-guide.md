...
현재 화면은 라우트 5개로 나뉘어 있고, src/features/shop/useShopState.ts 의 preview state로 동작합니다. 이 hook을 API 기반으로 바꾸세요.
...
- src/pages, src/layout, src/features/shop 의 책임을 분리해서 작업하세요.
